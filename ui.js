class UI {
                ...
                <div class="col-md-9">
                    ...
                    <span class="badge badge-info">Public Repos: ${user.following}</span>
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item mb-2">Website/Blog: <a href="${user.blog}" target="_blank">click here</a></li>
                            <li class="list-group-item mb-2">Joined: ${user.created_at}</li>
                        </ul>
                </div>
            </div>       
        </div>
    ...
    showAlert(message, className) {
        ...
        //clear current alert after 2.5sec
        setTimeout(() => {
            this.clearAlert();
        }, 2500);
    }
